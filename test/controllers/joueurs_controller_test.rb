...
class JoueursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joueur" do
    assert_difference("Joueur.count") do
      post joueurs_url, params: { joueur: { content: @joueur.content, image: @joueur.image, nom: @joueur.nom } }
    end
  ...
  test "should update joueur" do
    patch joueur_url(@joueur), params: { joueur: { content: @joueur.content, image: @joueur.image, nom: @joueur.nom } }
